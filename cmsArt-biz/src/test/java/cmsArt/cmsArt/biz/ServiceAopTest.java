package cmsArt.cmsArt.biz;

import cmsArt.cmsArt.model.constants.CommonErrors;
import cmsArt.cmsArt.model.dto.request.DemoRequest;
import cmsArt.cmsArt.model.dto.response.CommonResponse;
import cmsArt.cmsArt.service.CmsDemoService;
...
public class ServiceAopTest extends AbstractServiceTest {
    ...
    @Autowired
    private CmsDemoService cmsArtDemoService;
    ...
    public void testValidWithRespCode0000() {
        ...
        CommonResponse response = cmsArtDemoService.hello(request);
        log.info(response);
    ...
    public void testParamWithRespCode0000() {
        CommonResponse response = cmsArtDemoService.world("1234", 12);
        log.info(response);
    ...
    public void testParamWithRespCode2222() {
        CommonResponse response = cmsArtDemoService.world("1234", 123);
        log.info(response);
